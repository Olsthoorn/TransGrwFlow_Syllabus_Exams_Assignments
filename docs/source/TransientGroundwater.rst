...
#. Sections `[chap:Introduction-to-transient] <#chap:Introduction-to-transient>`__ through `[sec:Elastic-Storage] <#sec:Elastic-Storage>`__. Check yourself by answering the questions. Skip :ref:`sec:Earth-tides`.

#. Sections `[sec:Scope-5-1] <#sec:Scope-5-1>`__ through `[sec:Sinusoidal-fluctuations] <#sec:Sinusoidal-fluctuations>`__, to the extent that you understand and can answer the questions in :ref:`subsec:Questions-5-3-5`.

#. Sections `[subsec:Basins-of-half-infinite-lateral-extent] <#subsec:Basins-of-half-infinite-lateral-extent>`__ through `[subsec:Questions-5-4-2] <#subsec:Questions-5-4-2>`__. Understand how the erfc function works, understand that that the differential equation is a water balance, and understand what the parameters in the solution mean. Answer the questions in :ref:`subsec:Questions-5-4-2`.

#. Skip :ref:`sec:Higher-level-solutions` and `[subsec:Questions-5-4-4] <#subsec:Questions-5-4-4>`__; they may be useful as a future reference.

#. :ref:`subsec:Superposition-in-time-half-inf-aquifer`. Understand how superposition in time works, and how to apply it when the analytic solution is provided.

#. Sections `[subsec:Introduction-5-5-1] <#subsec:Introduction-5-5-1>`__ through `[subsec:Questions-5-5-5] <#subsec:Questions-5-5-5>`__. Understand how superposition in space works. Answer the questions of :ref:`subsec:Questions-5-5-5`.

#. :ref:`sec:Symmetrical-drainage-from-charcteristic-time`. Understand what the formula in :ref:`subsec:Analytical-solution`\ means and how we cracked it down to a characteristic time for groundwater systems and to their halftime in :ref:`subsec:Long-term-drainage-behavior-drainage`. Check if you can answer the questions in :ref:`subsec:Questions-5-6-3`.

#. Chapter `[chap:Transient-flow-to-wells] <#chap:Transient-flow-to-wells>`__: transient flow to wells.

#. :ref:`sec:Introduction-6-1` and `[sec:Wells-and-well] <#sec:Wells-and-well>`__: introduction to wells.

#. :ref:`sec:General-relation-between-well-solutions`, Theis: Relation between the transient and steady-state well solutions. The Theis solution and its approximation.
...
.. _chap:Introduction-to-transient:
...
.. _chap:Irreversible-transient-phenomena:
...
.. _chap:Reversible-groundwater-storage:
...
.. _chap:One-dimensional-transient-flow:
...
.. _subsec:Basins-of-half-infinite-lateral-extent:
...
.. _subsec:Superposition-in-time-half-inf-aquifer:
...
.. _chap:Transient-flow-to-wells:

Transient flow to wells
==========================================================

.. _sec:Introduction-6-1:
...
.. _sec:General-relation-between-well-solutions:
...
.. _sec:Pumping-test-analyses:

Pumping-test analyses
-----------------------------------------------------

.. _subsec:Introduction-6-6-1:
...
.. _subsec:Analysis-Theis-log-approx:
